...
function library:new(props)
	...
	local color = props.color or props.Color or props.mainColor or props.maincolor or props.MainColor or props.Maincolor or props.Accent or props.accent or Color3.fromRGB(39, 58, 235)
	-- // variables
	local window = {}
	-- // main
...
function library:loader(props)
	...
	local outline = utility.new(
		...
		{
			AnchorPoint = Vector2.new(0.5,0.5),
			BackgroundColor3 = Color3.fromRGB(39, 58, 235),
			BorderColor3 = Color3.fromRGB(12, 12, 12),
			BorderSizePixel = 1,
	...
	local title = utility.new(
		"TextLabel",
		{
			...
			Font = "RobotoMono",
			Text = name,
			TextColor3 = Color3.fromRGB(39, 58, 235),
	...
	close[3].MouseButton1Down:Connect(function()
		close[2].BorderColor3 = Color3.fromRGB(39, 58, 235)
	...
	login[3].MouseButton1Down:Connect(function()
		login[2].BorderColor3 = Color3.fromRGB(39, 58, 235)
		outline:TweenPosition(UDim2.new(1.5,0,0.5,0),Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.75,true)
		logedin()
		wait(0.05)
